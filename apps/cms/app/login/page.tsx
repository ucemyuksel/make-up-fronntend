...
export const metadata = { title: "İçerik Yönetimi Girişi · GlamGuide" };

/**
 * Icerik yonetimi girisi - kendi formumuz.
 *
    ...
    <main style={{ maxWidth: 440, margin: "10vh auto", padding: "0 20px" }}>
      <Card>
        <div style={{ padding: 28 }}>
          <h1 style={{ margin: "0 0 6px", fontSize: 26 }}>İçerik Yönetimi Girişi</h1>
          <p style={{ margin: "0 0 22px", opacity: 0.7, fontSize: 14, lineHeight: 1.6 }}>
            Katalog ve içerik yönetimi için yönetici hesabınızla girin.
          </p>
